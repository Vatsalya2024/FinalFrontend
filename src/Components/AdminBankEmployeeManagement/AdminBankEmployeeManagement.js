...
function AdminBankEmployeeManagement() {
    ...
    const handleGetEmployeeById = () => {
        ...
        fetch(`http://localhost:5134/api/AdminBankEmployees/getemployeebyid?employeeId=${employeeIdInput}`, {
            method: 'GET',
            headers: {
                'accept': 'application/json',
                'Authorization': 'Bearer ' + token
    ...
    const handleDeactivateEmployee = () => {
        ...
        fetch(`http://localhost:5134/api/AdminBankEmployees/DeactivateEmployee?employeeId=${employeeIdInput}`, {
            method: 'POST',
            headers: {
                'accept': 'application/json',
                'Authorization': 'Bearer ' + token
    ...
    const handleActivateEmployee = () => {
        ...
        fetch(`http://localhost:5134/api/AdminBankEmployees/ActivateEmployee?employeeId=${employeeIdInput}`, {
            method: 'POST',
            headers: {
                'accept': 'application/json',
                'Authorization': 'Bearer ' + token
    ...
    const handleUpdateEmployee = () => {
        ...
        fetch(`http://localhost:5134/api/AdminBankEmployees/UpdateBankEmployee?employeeId=${employeeIdInput}`, {
            method: 'PUT',
            headers: {
                'accept': 'application/json',
                'Content-Type': 'application/json',

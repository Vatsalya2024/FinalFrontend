      ...
      <Router>
        <div>
          <Routes>
            ...
            <Route path="/login/bankemployeelogin" element={<><BankEmployeeLoginNavigation/><BankEmployeeLogin /></>} />
            <Route path="/login/adminlogin" element={<><AdminLoginNavigation/><AdminLogin /></>} />
            <Route path='/bankemployeeregister' element={<BankEmployeeRegistraion/>}/>

            <Route path="/admincustomermanagement" element={<><PrivateRouteA/><AdminNavigation /><AdminCustomerManagement /></>} />
            <Route path="/adminbankemployeemanagement" element={<><PrivateRouteA/><AdminNavigation /><AdminBankEmployeeManagement /></>} />

            <Route path="/bankemployee/account/*" element={<>
              <BankEmployeeNavigation />
              <Routes>
                <Route path="/" element={<><PrivateRouteBE/><BankEmployeeAccount /></>} />
                <Route path="loans" element={<><PrivateRouteBE/><BankEmployeeLoan /></>} />
                <Route path="transactions" element={<><PrivateRouteBE/><BankEmployeeTransaction /></>} />
              </Routes>
            </>} />
            ...
            <Route path='/bankemployeeprofile' element={<><BankEmployeeNavigation/><EmployeeInfo/></>}/>
            <Route path='/forgotpasswordbe' element={<><Navigation/><ForgotPasswordBE/></>}/>
          </Routes>
        </div>
      </Router>
    </AuthProvider>

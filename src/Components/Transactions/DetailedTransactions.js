...
function DetailedTransactions() {
    ...
    const fetchTransactionsBetweenDates = () => {
        ...
        fetch(`http://localhost:5134/api/CustomerTransaction/TransactionsBetweenDates?accountNumber=${accountNumber}&startDate=${formattedStartDate}&endDate=${formattedEndDate}`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
    ...
    const fetchLast10Transactions = () => {
        ...
        fetch(`http://localhost:5134/api/CustomerTransaction/Last10Transactions?accountNumber=${accountNumber}`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Authorization': 'Bearer ' + token
    ...
    const fetchLastMonthTransactions = () => {
        ...
        fetch(`http://localhost:5134/api/CustomerTransaction/LastMonthTransactions?accountNumber=${accountNumber}`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Authorization': 'Bearer ' + token
                    ...
                    <div className='card'>
                        <div className="transactions-section">
                            ...
                            <div className='button-container'>
                                <button className="btn buttons" onClick={fetchTransactionsBetweenDates}>Fetch Transactions</button>
                                <button className='btn cancel qw' onClick={handleCancel}>Close</button>
                            </div>
                            {err && <p>{err}</p>}
                ...
                <div className="col mt-4">
                    <div className='card'>
                        <div className="transactions-section">
                            ...
                            <div className='button-container'>
                                <button className="btn buttons" onClick={fetchLast10Transactions}>Fetch Last 10 Transactions</button>
                                <button className='btn cancel qe' onClick={handleCancel}>Close</button>
                            </div>
                            {err1 && <p>{err1}</p>}
                            <div className="transactions-list">
                ...
                <div className="col mt-4">
                    <div className='card'>
                        <div className="transactions-section">
                            ...
                            <div className='button-container'>
                                <button className="btn buttons" onClick={fetchLastMonthTransactions}>Fetch Last Month Transactions</button>
                                <button className='btn cancel qr' onClick={handleCancel}>Close</button>
                            </div>
                            {err2 && <p>{err2}</p>}
                            <div className="transactions-list">

...
function CustomerTransactions() {
    ...
    const handleDeposit = () => {
        ...
        fetch(`http://localhost:5134/api/CustomerTransaction/deposit?customerId=${customerId}`, {
        method: 'POST',
        headers: {
            'accept': '*/*',
    ...
    const handleWithdraw = () => 
        ...
        fetch(`http://localhost:5134/api/CustomerTransaction/withdraw?customerId=${customerId}`, {
            method: 'POST',
            headers: {
                'accept': '*/*',
                'Content-Type': 'application/json',
    ...
    const handleTransfer = () => {
        ...
        if(transferSourceAccountNumber===destinationAccountNumber){
            setTransferMessage('Source Account and Destination Account should be different');
            return;
        }
        const requestBody = {
        ...
        fetch(`http://localhost:5134/api/CustomerTransaction/transfer?customerId=${customerId}`, {
            method: 'POST',
            headers: {
                'accept': '*/*',
                'Content-Type': 'application/json',
    ...
    return (
        <div className="container">
            ...
            <div className='button-container'>
                ...
                <Link to="/beneficiary" className="btn buttons divbuttons yu">Beneficiary Service</Link>
            </div>
        ...
        .map(account => (
            <option key={account.accountNumber} value={account.accountNumber}>{account.accountNumber}</option>
                    ...
                    <div className='button-container'>
                        ...
                        <button className='btn cancel rt' onClick={handleCancel}>Close</button>
                    </div>
        ...
        .map(account => (
            <option key={account.accountNumber} value={account.accountNumber}>{account.accountNumber}</option>
                    ...
                    <div className='button-container'>
                        ...
                        <button className='btn cancel ui' onClick={handleCancel}>Close</button>
                    </div>
...
>
    ...
    {customerAccounts
        ...
        <div className='button-container'>
            ...
            <button className='btn cancel uo' onClick={handleCancel} >Close</button>
        </div>

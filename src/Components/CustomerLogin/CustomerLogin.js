                            ...
                            <div className="card-body">
                                ...
                                <form>
                                    ...
                                    <div className='button loginbutton w-25 mx-auto'>
                                        <button onClick={login} className="btn  success mx-auto">Login</button>
                                    </div>
                                    ...
                                    <Link to="/register" className="btn-link xd mx-auto ">New Customer,Register</Link><br/>
                                    <Link to="/forgotpassword" className='btn-link fogotpasswordlink mx-auto'>Forgot Password?</Link>
                                    </div>
